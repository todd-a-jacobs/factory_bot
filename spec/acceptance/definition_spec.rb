describe "whatever" do
  it "works" do
    ...
    FactoryBot.define do
      factory :base, abstract: true
      factory :user, parent: :base
      factory :admin, parent: :base
    end

    expect(FactoryBot.build(:user)).to be_a User
    expect(FactoryBot.build(:admin)).to be_a Admin
  end
end
